...
std::vector<Triangle> create_parallelepiped(
    ...
    const Vector3 vertices[8] = {
        Vector3(center.x - hx, center.y - hy, center.z - hz), // 0
        Vector3(center.x + hx, center.y - hy, center.z - hz), // 1
        Vector3(center.x + hx, center.y + hy, center.z - hz), // 2
        Vector3(center.x - hx, center.y + hy, center.z - hz), // 3
        Vector3(center.x - hx, center.y - hy, center.z + hz), // 4
        Vector3(center.x + hx, center.y - hy, center.z + hz), // 5
        Vector3(center.x + hx, center.y + hy, center.z + hz), // 6
        Vector3(center.x - hx, center.y + hy, center.z + hz)  // 7
    };
